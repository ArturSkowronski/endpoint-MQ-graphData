    ...
    <div class="row">
        <div class="span8 offset2">
            ...
            <div style="margin-bottom: 20px">
                ...
                Redis
                <div class="alert alert-success">
                    Redis to baza w pamieci zainspirowana przez memcache. Do struktury klucz-> wartość nakłada dodatkowe struktury danych i operacje atomowe na nich. Pokażę jak mechanizmy transakcji i atomowość pomagają przekładać ciężar niektórych algorytmów do Redisa.
                </div>
                </ul>
            </div>
